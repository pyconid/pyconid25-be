...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_public_room_id"), "room", ["id"], unique=False, schema="public"
    )
    op.create_table(
        "schedule_type",
        sa.Column("id", sa.UUID(), nullable=False),
    ...
    op.create_index(
        op.f("ix_public_schedule_type_id"),
        "schedule_type",
        ["id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_public_stream_id"), "stream", ["id"], unique=False, schema="public"
    )
    op.create_index(
        op.f("ix_public_stream_is_public"),
        "stream",
        ["is_public"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_public_stream_mux_live_stream_id"),
        "stream",
        ["mux_live_stream_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_public_stream_mux_playback_id"),
        "stream",
        ["mux_playback_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_public_stream_schedule_id"),
        "stream",
        ["schedule_id"],
        unique=False,
        schema="public",
    ...
    op.add_column(
        "schedule", sa.Column("presentation_language", sa.String(), nullable=True)
    )
    ...
    op.add_column(
        "schedule", sa.Column("tags", postgresql.ARRAY(sa.String()), nullable=True)
    )
    op.create_index(
        op.f("ix_public_schedule_room_id"),
        "schedule",
        ["room_id"],
        unique=False,
        schema="public",
    ...
    op.create_index(
        op.f("ix_public_schedule_schedule_type_id"),
        "schedule",
        ["schedule_type_id"],
        unique=False,
        schema="public",
...
def downgrade() -> None:
    ...
    op.add_column(
        "schedule",
        sa.Column("stream_link", sa.VARCHAR(), autoincrement=False, nullable=True),
    )
    op.drop_constraint(
        "fk_schedule_room_id", "schedule", schema="public", type_="foreignkey"
    )
    op.drop_constraint(
        "fk_schedule_schedule_type_id", "schedule", schema="public", type_="foreignkey"
    )
    op.drop_index(
        op.f("ix_public_schedule_schedule_type_id"),
        table_name="schedule",
    ...
    op.drop_index(
        op.f("ix_public_schedule_room_id"), table_name="schedule", schema="public"
    )
    ...
    op.drop_index(
        op.f("ix_public_stream_schedule_id"), table_name="stream", schema="public"
    )
    op.drop_index(
        op.f("ix_public_stream_mux_playback_id"), table_name="stream", schema="public"
    )
    op.drop_index(
        op.f("ix_public_stream_mux_live_stream_id"),
        table_name="stream",
    ...
    op.drop_index(
        op.f("ix_public_stream_is_public"), table_name="stream", schema="public"
    )
    op.drop_index(op.f("ix_public_stream_id"), table_name="stream", schema="public")
    op.drop_table("stream", schema="public")
    op.drop_index(
        op.f("ix_public_schedule_type_id"), table_name="schedule_type", schema="public"
    )
